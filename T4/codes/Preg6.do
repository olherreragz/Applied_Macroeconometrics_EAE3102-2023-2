...
forv h = 0/`hmax' {
	...
	replace b_PrecioCobre_pos = _b[shocks]                    	  if _n == `h'+1 // Desde h == 1
	replace u_PrecioCobre_pos = _b[shocks] + 1.645* _se[shocks]  if _n == `h'+1 //t_{0.9} = 1.645
	replace d_PrecioCobre_pos = _b[shocks] - 1.645* _se[shocks]  if _n == `h'+1
}
...
forv h = 0/`hmax' {
	...
	replace u_neg_imacec = -_b[shocks] + 1.645*sqrt(_se[shocks]^2 + _se[interaccion]^2)  if _n == `h'+1 //t_{0.9} = 1.645
	replace d_neg_imacec = -_b[shocks] - 1.645*sqrt(_se[shocks]^2 + _se[interaccion]^2)  if _n == `h'+1
}
...
forv h = 0/`hmax' {
	...
	replace u_neg_imacec_NM = -_b[shocks] + 1.645*sqrt(_se[shocks]^2 + _se[interaccion]^2)  if _n == `h'+1 //t_{0.9} = 1.645
	replace d_neg_imacec_NM = -_b[shocks] - 1.645*sqrt(_se[shocks]^2 + _se[interaccion]^2)  if _n == `h'+1
}
...
forv h = 0/`hmax' {
	...
	replace u_neg_inflacion = -_b[shocks] + 1.645*sqrt(_se[shocks]^2 + _se[interaccion]^2)  if _n == `h'+1 //t_{0.9} = 1.645
	replace d_neg_inflacion = -_b[shocks] - 1.645*sqrt(_se[shocks]^2 + _se[interaccion]^2)  if _n == `h'+1
}
